...
public class IStructureTreeModel <Structure extends AbstractTreeStructure>
    ...
    private final IReference<Node> root = new IReference<>();
    private final String description;
    private final Invoker invoker;
    private final Structure structure;
    private volatile Comparator<? super Node> comparator;

    private IStructureTreeModel(@NotNull Structure structure, boolean background, @NotNull Disposable parentDisposable) {
        this.structure = structure;
        description = format(structure.toString());
        invoker = background
                ? new Invoker.BackgroundPool(this)
                : new Invoker.EDT(this);
        Disposer.register(parentDisposable, this);
    }

    public IStructureTreeModel(@NotNull Structure structure, @NotNull Disposable parentDisposable) {
        this(structure, true, parentDisposable);
    }

    public IStructureTreeModel(@NotNull Structure structure,
    ...
    private static final class Node extends DefaultMutableTreeNode implements LeafState.Supplier {
        private final IReference<List<Node>> children = new IReference<>();
