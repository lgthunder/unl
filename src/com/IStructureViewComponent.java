...
public class IStructureViewComponent extends SimpleToolWindowPanel implements TreeActionsOwner, DataProvider, StructureView.Scrollable {
...
// written from EDT only
    ...
    public IStructureViewComponent(@Nullable FileEditor editor,
