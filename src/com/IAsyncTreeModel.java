...
public class IAsyncTreeModel extends AbstractTreeModel implements Identifiable, Searchable, Navigatable, TreeVisitor.Acceptor {
    private static final Logger LOG = Logger.getInstance(IAsyncTreeModel.class);
    ...
    /**
     * @deprecated use {@link #IAsyncTreeModel(TreeModel, Disposable)} instead
     */
    @Deprecated
    public IAsyncTreeModel(@NotNull TreeModel model) {
        this(model, true);
    }

    /**
     * @deprecated use {@link #IAsyncTreeModel(TreeModel, boolean, Disposable)} instead
     */
    @Deprecated
    public IAsyncTreeModel(@NotNull TreeModel model, boolean showLoadingNode) {
    ...
    public IAsyncTreeModel(@NotNull TreeModel model, @NotNull Disposable parent) {
        this(model, true, parent);
    }

    public IAsyncTreeModel(@NotNull TreeModel model, boolean showLoadingNode, @NotNull Disposable parent) {
